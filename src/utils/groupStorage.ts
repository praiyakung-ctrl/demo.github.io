...
export const DEFAULT_GROUPS: UserGroup[] = [
  {
    ...
    isSystem: true,
    permissions: {
      map: ALL, dashboard: VIEW, portal: ALL, reports: VIEW, liveViewer: ALL, comparisonReport: ALL,
  ...
  },
  {
    ...
    isSystem: true,
    permissions: {
      map: VIEW, dashboard: VIEW, portal: VIEW, reports: VIEW, liveViewer: VIEW, comparisonReport: VIEW,
      adminCameras: NONE, adminUsers: NONE, adminRepairs: NONE, adminGroups: NONE, adminMenus: NONE,
  ...
  },
  {
    ...
    isSystem: true,
    permissions: {
      map: NONE, dashboard: NONE, portal: ALL, reports: NONE, liveViewer: NONE, comparisonReport: NONE,
      adminCameras: NONE, adminUsers: NONE, adminRepairs: NONE, adminGroups: NONE, adminMenus: NONE,
      adminAuditLog: NONE, adminApi: NONE, adminNotifications: NONE, adminSettings: NONE, adminIncidents: NONE,
    },
  },
  {
    ...
    isSystem: true,
    permissions: {
      map: NONE, dashboard: NONE, portal: VIEW, reports: NONE, liveViewer: NONE, comparisonReport: NONE,
      adminCameras: NONE, adminUsers: NONE, adminRepairs: NONE, adminGroups: NONE, adminMenus: NONE,
      adminAuditLog: NONE, adminApi: NONE, adminNotifications: NONE, adminSettings: NONE, adminIncidents: NONE,
    },
  },

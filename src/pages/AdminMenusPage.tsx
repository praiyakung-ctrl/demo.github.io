      ...
      <div className="flex flex-col h-full">
        ...
        <div className="bg-navy-700 px-6 py-4 flex items-center justify-between shadow-md flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-white">จัดการเมนู</h1>
              <p className="text-sm text-navy-200 mt-0.5">เปลี่ยนชื่อ จัดลำดับ และเปิด/ปิดเมนูของระบบ (มีผลกับทุกกลุ่มผู้ใช้)</p>
            </div>
          </div>
        </div>

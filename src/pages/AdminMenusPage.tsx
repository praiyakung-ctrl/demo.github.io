...
const MENU_PATHS: Record<string, string> = {
  map: '/map', dashboard: '/dashboard', portal: '/portal', reports: '/reports', comparisonReport: '/reports/comparison', lprSearch: '/reports/lpr', policeUsage: '/reports/police-usage',
  ...
  adminMemberReview: '/admin/member-review',
  adminCctvApprovers: '/admin/cctv-approvers',
};

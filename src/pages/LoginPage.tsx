...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundImage: 'linear-gradient(rgba(27,58,107,0.8), rgba(37,99,235,0.8)), url(/camera001.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      {/* Left: Form */}
      <div className="flex-1 flex items-center justify-center p-8">
      <div className="w-full max-w-md">
        {/* Logo + Title */}
        <div className="text-center mb-8">
          <img src={`${import.meta.env.BASE_URL}camera001.jpg`} alt="อบจ.ชลบุรี" className="h-32 w-32 mx-auto mb-4 object-contain" />
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-8">
        <div className="relative w-3/4 max-h-[70vh] rounded-2xl overflow-hidden shadow-2xl">
          <img src="/camera005.jpg" alt="CCTV Camera" className="w-full h-full object-cover" style={{ objectPosition: 'center 53%' }} />
